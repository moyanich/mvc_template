...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 06, 2020 at 01:31 AM
...
INSERT INTO `tbldepartment_employee` (`empID`, `jobID`, `depID`, `from_date`, `to_date`, `created_by`, `modified_on`) VALUES
(94, 1, 'dep1', '2020-10-05 23:08:01', NULL, 0, '2020-10-05 23:08:51');
...
(6, 'Machine Operator', 'screenshot-www.phoenixprintery.com-2020.06.15-10_49_16.png', '2020-10-06 01:19:58', '2020-10-06 01:19:58', 7),
(7, 'test', NULL, '2020-10-06 01:28:39', '2020-10-06 01:28:39', 7);
...
ALTER TABLE `tbldepartment_employee`
  ...
  ADD CONSTRAINT `titles_ibfk_1` FOREIGN KEY (`jobID`) REFERENCES `tbljobtitles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
