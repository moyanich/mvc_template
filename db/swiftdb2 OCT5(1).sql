...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 05, 2020 at 09:09 PM
...
('1001', 'Sales', '2020-10-05 18:01:57', 7, '2020-10-05 19:21:46'),
('dep0', 'Productioner', '2020-10-05 17:33:32', 7, '2020-10-05 19:18:03'),
('dep1', 'Marketing', '2020-10-05 17:33:32', 7, NULL),
('dep2', 'Finance', '2020-10-05 17:33:32', 7, NULL),
('dep3', 'Human Resources', '2020-10-05 17:33:32', 7, NULL),
('dep4', 'Production', '2020-10-05 17:33:32', 7, NULL),
('dep5', 'Development', '2020-10-05 17:33:32', 7, NULL),
('dep6', 'Quality Management', '2020-10-05 17:33:32', 7, NULL),
('dep8', 'Research', '2020-10-05 17:33:32', 7, NULL),
('dep9', 'Customer Service', '2020-10-05 17:33:32', 7, NULL);
...
CREATE TABLE IF NOT EXISTS `tbldepartment_employee` (
  ...
  `depID` char(6) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `tbldepartment_employee` (`empID`, `depID`, `from_date`, `to_date`) VALUES
(94, 'dep0', '2020-10-01', NULL),
(94, 'dep2', '2020-10-01', NULL);
...
(93, 'Ryders', 'Jayme Whitney', 'Chapman', '1949-12-19', '2009-12-19', '567345879', 'BX4532', 'Female', '1981-02-26', '14 Terry Road', 'Spanish Town', 'Clarendon', '', '', '', 'test@email.com', NULL, '2020-09-11 15:06:20', '2020-09-26 22:18:00', 7),
...
INSERT INTO `tbljobtitles` (`empID`, `title`, `from_date`, `to_date`, `created_date`) VALUES
(94, 'SMachine Ope', '2020-10-01', NULL, '2020-10-05 20:10:28');
...
ALTER TABLE `tbldepartment_employee`
  ADD CONSTRAINT `dept_emp_ibfk_1` FOREIGN KEY (`empID`) REFERENCES `tblemployees` (`empID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `dept_emp_ibfk_2` FOREIGN KEY (`depID`) REFERENCES `tbldepartment` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `tbljobtitles`
  ADD CONSTRAINT `titles_ibfk_1` FOREIGN KEY (`empID`) REFERENCES `tblemployees` (`empID`) ON DELETE CASCADE ON UPDATE CASCADE;
