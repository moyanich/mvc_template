...
--
-- Host: localhost:8889
-- Generation Time: Oct 14, 2020 at 08:25 PM
...
--
ALTER TABLE `tblactivitylog`
  MODIFY `idActivity` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=330;
...
--
ALTER TABLE `tbluserlogs`
  MODIFY `idLogs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=291;
