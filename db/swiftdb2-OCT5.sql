...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 05, 2020 at 05:17 PM
...
CREATE TABLE IF NOT EXISTS `tbldepartments` (
  ...
  `relSupID` int(11) DEFAULT NULL,
  `relManagerID` int(11) DEFAULT NULL,
  ...
  KEY `relSupIDFK` (`relSupID`),
  KEY `relMngIDFK` (`relManagerID`)
...
INSERT INTO `tbldepartments` (`id`, `deptCode`, `deptName`, `relSupID`, `relManagerID`, `created_date`, `modified_on`, `created_by`) VALUES
(2, 'DEP78', 'Product Management Systems', NULL, NULL, '2020-07-29 19:01:09', '2020-09-11 13:39:06', 7),
(4, 'PPLACC', 'Accounting Department', NULL, NULL, '2020-07-29 19:01:09', '2020-09-02 20:15:44', 7),
(5, 'dep3', 'Information Technology', NULL, NULL, '2020-07-29 19:01:09', '2020-07-31 15:32:13', 7),
(7, 'SUN', 'Bindery', NULL, NULL, '2020-08-04 14:45:54', '2020-09-02 19:55:56', 7),
(44, 'LABORE', 'Corporate Department', NULL, NULL, '2020-09-17 16:22:14', '2020-10-02 14:52:12', 7),
(45, 'MGM', 'Manufacturing', 177, 174, '2020-10-03 21:05:02', NULL, 7),
(46, '1=1', 'tom', 113, 163, '2020-10-04 19:23:28', NULL, 7);
...
INSERT INTO `tblempjobhistory` (`id`, `job`, `relEmpID`, `relDeptID`, `date_promoted`, `created_date`, `created_by`) VALUES
(1, 'Merchant of  Venice', 171, 2, NULL, '2020-09-26 23:45:24', 7),
(4, 'Cruncher', 93, NULL, NULL, '2020-09-28 16:30:56', 7),
(5, 'Technician', 93, 4, NULL, '2020-09-28 16:49:34', 7),
(6, 'Sprinter', 93, 2, '2020-10-01', '2020-10-04 21:35:53', 7),
(8, 'dami=egw', 93, 2, '2020-10-04', '2020-10-04 21:39:40', 7),
(9, 'twtwtw', 93, 5, '2020-10-04', '2020-10-04 21:41:43', 7),
(10, 'DAAMN/TJRT', 93, 2, '2020-10-04', '2020-10-04 21:47:05', 7),
(11, 'sgwsws774//', 93, 2, '2020-10-04', '2020-10-04 21:53:14', 7),
(12, 'wgw3//===', 93, 2, '2020-10-04', '2020-10-04 21:54:15', 7),
(13, '@fwww', 93, 2, '2020-10-04', '2020-10-04 22:03:34', 7),
(14, '@qrqrqw', 93, 2, '2020-10-04', '2020-10-04 22:03:46', 7),
(15, '@rwrw+=', 93, 2, '2020-10-05', '2020-10-05 16:34:58', 7);
...
CREATE TABLE IF NOT EXISTS `tblemployees` (
  ...
  `relJobHistory` int(11) DEFAULT NULL,
  `relDeptID` int(11) DEFAULT NULL,
  `address` text,
  ...
  KEY `relJobHistoryFK` (`relJobHistory`)
...
INSERT INTO `tblemployees` (`id`, `empID`, `first_name`, `middle_name`, `last_name`, `empDOB`, `retirementDate`, `trn`, `nis`, `gender`, `hire_date`, `relJobHistory`, `relDeptID`, `address`, `city`, `parish`, `phoneOne`, `mobile`, `internalEmail`, `externalEmail`, `photo`, `created_date`, `modified_at`, `created_by`) VALUES
(93, 'DOEN', 'Ryders', 'Jayme Whitney', 'Chapman', '1949-12-19', '2009-12-19', '567345879', 'BX4532', 'Female', '1981-02-26', 15, 5, '14 Terry Road', 'Spanish Town', 'Clarendon', '', '', '', 'test@email.com', NULL, '2020-09-11 15:06:20', '2020-09-26 22:18:00', 7),
(94, 'EUM', 'Joan', 'Elvis', 'Stafford', '1961-08-26', '2021-08-26', '556932641', 'ctr266', 'Female', '2002-06-12', NULL, 5, 'Et at corporis ut su', 'Qui eum sit adipisc', 'St. Elizabeth', '2856698223', '20', '', 'nugoxol@mailinator.com', NULL, '2020-09-11 15:11:08', '2020-09-22 13:26:47', 7),
...
(97, 'QUASI', 'Roanna', 'Alea Cortez', 'Ellis', '2009-12-26', '2074-12-26', '252222623', 'EHWY2T2', 'Male', '2015-05-06', NULL, 5, '', '', '', '875-555-5555', '875-555-5666', '', '', NULL, '2020-09-11 15:21:12', '2020-10-02 15:24:50', 7),
...
CREATE TABLE IF NOT EXISTS `tbljobs` (
  ...
  `relDeptID` int(11) DEFAULT NULL,
  `jobDesc_path` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modified_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `DeptIDfk` (`relDeptID`)
...
INSERT INTO `tbljobs` (`id`, `job`, `relDeptID`, `jobDesc_path`, `created_date`, `modified_date`) VALUES
(38, 'Manager', 2, NULL, '2020-10-03 19:22:52', '2020-10-03 19:22:52'),
(40, 'Manager', 5, NULL, '2020-10-03 20:21:57', '2020-10-03 20:21:57');
...
ALTER TABLE `tbldepartments`
  ADD CONSTRAINT `relMngIDFK` FOREIGN KEY (`relManagerID`) REFERENCES `tblemployees` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `relSupIDFK` FOREIGN KEY (`relSupID`) REFERENCES `tblemployees` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE `tblemployees`
  ...
  ADD CONSTRAINT `relJobHistoryFK` FOREIGN KEY (`relJobHistory`) REFERENCES `tblempjobhistory` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
--
ALTER TABLE `tbljobs`
  ADD CONSTRAINT `DeptIDfk` FOREIGN KEY (`relDeptID`) REFERENCES `tbldepartments` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
