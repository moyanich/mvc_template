...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 27, 2020 at 01:11 AM
...
ALTER TABLE `tblempjobhistory`
  ...
  ADD CONSTRAINT `deptFK` FOREIGN KEY (`relDeptID`) REFERENCES `tbldepartments` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
