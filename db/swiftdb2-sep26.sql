...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 26, 2020 at 03:31 PM
...
(93, 'DOEN', 'Ryders', 'Jayme Whitney', 'Chapman', '1949-12-19', '2009-12-19', '567345879', 'BX4532', 'Female', '1981-02-26', '14 Terry Road', 'Spanish Town', 'Clarendon', '', '', '', '', NULL, '2020-09-11 15:06:20', '2020-09-26 14:36:03', 7),
...
IF OLD.first_name <> new.first_name THEN
	INSERT INTO tblActivityLog (relUserID, action)
	VALUES(OLD.created_by,
	CONCAT('<a href="../employees/profile/', NEW.id ,'">' , OLD.first_name, ' ', OLD.last_name, '</a> Updated <br/> New First Name: ', NEW.first_name));
END IF;
...
IF OLD.gender <> new.gender THEN
	INSERT INTO tblActivityLog (relUserID, action)
	VALUES(OLD.created_by,
	CONCAT('<a href="../employees/profile/', NEW.id ,'">' , OLD.first_name, ' ', OLD.last_name, '</a> Gender changed from ', OLD.gender, ' to ', NEW.gender));
END IF;

IF OLD.empDOB <> new.empDOB THEN
	INSERT INTO tblActivityLog (relUserID, action)
	VALUES(OLD.created_by,
	CONCAT('<a href="../employees/profile/', NEW.id ,'">' , OLD.first_name, ' ', OLD.last_name, '</a> DOB Updated ', OLD.empDOB, ' to ', NEW.empDOB));
END IF;
...
IF OLD.trn <> new.trn THEN
	INSERT INTO tblActivityLog (relUserID, action)
	VALUES(OLD.created_by,
	CONCAT('<a href="../employees/profile/', NEW.id ,'">' , OLD.first_name, ' ', OLD.last_name, '</a> TRN Updated: ', NEW.trn));
END IF;
