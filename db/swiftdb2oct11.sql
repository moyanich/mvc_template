...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 11, 2020 at 11:21 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `EmployeeDept` (IN `relEmpID` INT(11), IN `relDeptID` INT(11), IN `created_date` TIMESTAMP)  NO SQL
BEGIN
...
DROP PROCEDURE IF EXISTS `updateManagerTable`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `updateManagerTable` (IN `empID` CHAR(6), IN `deptID` INT(11), IN `from_date` DATE, IN `to_date` DATE)  NO SQL
BEGIN
	INSERT INTO tbldepartment_manager(empID, deptID, from_date, to_date) 
    VALUES(empID, deptID, from_date, to_date);
END$$

DROP PROCEDURE IF EXISTS `update_MANAGER`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_MANAGER` (IN `empID` INT(11), IN `deptID` CHAR(8) CHARSET utf8)  NO SQL
BEGIN
	UPDATE tbldepartment_manager SET
    empID = empID
    WHERE deptID = deptID;
END$$

DROP PROCEDURE IF EXISTS `update_SUPERVISOR`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_SUPERVISOR` (IN `empID` INT(11), IN `deptID` CHAR(8))  NO SQL
BEGIN
	UPDATE tbldepartment_supervisor SET
   	empID = empID
    WHERE deptID = deptID;
END$$

DROP PROCEDURE IF EXISTS `update_tbl_DEPARTMENT_MANAGER`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_tbl_DEPARTMENT_MANAGER` (IN `empID` INT(11), IN `deptID` CHAR(8) CHARSET utf8)  NO SQL
BEGIN
	INSERT INTO tbldepartment_manager(empID, deptID) 
    VALUES(empID, deptID);
END$$

DROP PROCEDURE IF EXISTS `update_tbl_DEPARTMENT_SUPERVISOR`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_tbl_DEPARTMENT_SUPERVISOR` (IN `empID` INT(11), IN `deptID` CHAR(8))  NO SQL
BEGIN
	INSERT INTO tbldepartment_supervisor(empID, deptID) 
    VALUES(empID, deptID);
END$$
...
DROP TABLE IF EXISTS `archivesdepartmentemployee`;
CREATE TABLE IF NOT EXISTS `archivesdepartmentemployee` (
...
DROP TABLE IF EXISTS `archives_employees`;
CREATE TABLE IF NOT EXISTS `archives_employees` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `empID` int(11) NOT NULL,
...
INSERT INTO `archives_employees` (`id`, `empID`, `first_name`, `middle_name`, `last_name`, `empDOB`, `retirementDate`, `nis`, `gender`, `hire_date`, `address`, `city`, `parish`, `phoneOne`, `mobile`, `internalEmail`, `externalEmail`, `photo`, `created_date`, `modified_at`, `created_by`, `action`, `trn`) VALUES
(1, 0, 'Bree', 'Demetria Dyer', 'Key', '2020-10-06', '2085-10-06', 'VT363636', 'Male', '1954-12-28', '', '', 'Hanover', '', '', NULL, '', NULL, '2020-10-06 16:54:23', '2020-10-08 02:24:11', 7, 'update', '0'),
(2, 93, 'Ryders', 'Jayme', 'Chapman', '1950-01-31', '2015-01-31', 'BX4532', 'Male', '1982-05-29', '14 Tom Road', 'Mandeville', 'Manchester', '876-555-5555', '876-555-6666', 'gyqyhas@mailinator.com', 'test@email.com', NULL, '2020-09-11 15:06:20', '2020-10-08 01:26:16', 7, 'delete', '0'),
(3, 97, 'Roanna', 'Alea Cortez', 'Ellis', '2009-12-26', '2074-12-26', NULL, 'Male', '2015-05-06', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-09-11 15:21:12', '2020-10-08 02:05:34', 7, 'delete', '0'),
(4, 112, 'Bruce', '', 'Brewer', '1975-10-22', '2040-10-22', NULL, 'Male', '2010-11-05', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-09-14 19:50:20', '2020-10-08 02:04:25', 7, 'delete', '0'),
(5, 119, 'Josiah', 'Celeste Larson', 'Valenzuela', '1970-11-18', '2035-11-18', 'MED336', 'Male', '1978-12-26', 'nded', 'hedn', 'Hanover', '876-444-2422', '876-444-2677', 'rogyl@mailinator.com', NULL, NULL, '2020-09-14 20:01:41', '2020-10-08 02:17:47', 7, 'delete', '0'),
(6, 6369, 'Isabella', 'Thor Chase', 'Watkins', '1983-08-23', '2048-08-23', NULL, 'Male', '1991-09-17', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-10-08 01:39:08', '2020-10-08 01:39:08', 7, 'insert', '0'),
(7, 64, 'Bree', 'Demetria Dyer', 'Key', '2020-10-06', '2085-10-06', 'VT363636', 'Male', '1954-12-28', '', '', 'Hanover', '', '', NULL, '', NULL, '2020-10-06 16:54:23', '2020-10-08 02:26:12', 7, 'update', '0'),
(8, 64, 'Bree', 'Demetria Dyer', 'Key', '2020-10-06', '2085-10-06', 'VT363636', 'Male', '1954-12-28', '', '', 'Hanover', '', '', NULL, '', NULL, '2020-10-06 16:54:23', '2020-10-08 02:26:12', 7, 'update', '0'),
(9, 64, 'Bree', 'Demetria Dyer', 'Key', '2020-10-06', '2085-10-06', 'VT363636', 'Male', '1954-12-28', '', '', 'Portland', '', '', NULL, '', NULL, '2020-10-06 16:54:23', '2020-10-08 02:26:27', 7, 'update', '0'),
(10, 64, 'Bree', 'Demetria Dyer', 'Key', '2020-10-06', '2085-10-06', 'VT363636', 'Male', '1954-12-28', '', '', 'Portland', '', '', NULL, '', NULL, '2020-10-06 16:54:23', '2020-10-08 02:26:27', 7, 'update', '0'),
(11, 100, 'Suki', 'Ulric Olsen', 'Stanley', '1970-09-14', '2066-09-19', 'HT747444', 'Female', '2004-04-28', 'Adipisci vitae esse', 'Ratione dolorum amet', 'St. Elizabeth', '479-249-3047', '757-624-2067', '', 'mihyjoc@mailinator.com', NULL, '2020-09-11 15:25:05', '2020-10-08 02:27:45', 7, 'update', '0'),
(12, 100, 'Suki', 'Ulric Olsen', 'Stanley', '1970-09-14', '2030-09-14', 'HT747444', 'Female', '2004-04-28', 'Adipisci vitae esse', 'Ratione dolorum amet', 'St. Elizabeth', '479-249-3047', '757-624-2067', '', 'mihyjoc@mailinator.com', NULL, '2020-09-11 15:25:05', '2020-10-08 02:27:45', 7, 'update', '0'),
(13, 100, 'Suki', 'Ulric Olsen', 'Stanley', '1970-09-14', '2030-09-14', 'HT747444', 'Female', '2004-04-28', 'Adipisci vitae esse', 'Ratione dolorum amet', 'St. Andrew', '479-249-3047', '757-624-2067', '', 'mihyjoc@mailinator.com', NULL, '2020-09-11 15:25:05', '2020-10-08 02:28:49', 7, 'update', '0'),
(14, 100, 'Suki', 'Ulric Olsen', 'Stanley', '1970-09-14', '2030-09-14', 'HT747444', 'Female', '2004-04-28', 'Adipisci vitae esse', 'Ratione dolorum amet', 'St. Andrew', '479-249-3047', '757-624-2067', '', 'mihyjoc@mailinator.com', NULL, '2020-09-11 15:25:05', '2020-10-08 02:28:49', 7, 'update', '0'),
(15, 104, 'Serena', 'Len Dominguez', 'Albert', '2008-01-14', '2079-04-16', 'R2222T2', 'Female', '1998-07-27', 'Velit ipsa veritat', 'Perferendis in sequi', 'Kingston', '922-538-9941', '682-154-7347', '', 'juwyqofela@mailinator.com', NULL, '2020-09-14 19:19:28', '2020-10-09 12:57:22', 7, 'update', '0'),
(16, 104, 'Serena', 'Len Dominguez', 'Albert', '2008-01-14', '2068-01-14', 'R2222T2', 'Female', '1998-07-27', 'Velit ipsa veritat', 'Perferendis in sequi', 'Kingston', '922-538-9941', '682-154-7347', '', 'juwyqofela@mailinator.com', NULL, '2020-09-14 19:19:28', '2020-10-09 12:57:22', 7, 'update', '0'),
(17, 104, 'Serena', 'Len Dominguez', 'Albert', '2008-01-14', '2068-01-14', 'R2222T2', 'Female', '1998-07-27', 'Velit ipsa veritat', 'Perferendis in sequi', 'Kingston', '922-538-9941', '682-154-7347', '', 'juwyqofela@mailinator.com', NULL, '2020-09-14 19:19:28', '2020-10-09 12:57:42', 7, 'update', '0'),
(18, 104, 'Serena', 'Len Dominguez', 'Albert', '2008-01-14', '2068-01-14', 'R2222T2', 'Female', '1998-07-27', 'Velit ipsa veritat', 'Perferendis in sequi', 'Kingston', '922-538-9941', '682-154-7347', '', 'juwyqofela@mailinator.com', NULL, '2020-09-14 19:19:28', '2020-10-09 12:57:42', 7, 'update', '0'),
(19, 104, 'Serena', 'Len Dominguez', 'Albert', '2008-01-14', '2068-01-14', 'R2222T2', 'Female', '1998-07-27', 'Velit ipsa veritat', 'Perferendis in sequi', 'Kingston', '922-538-9941', '682-154-7347', '', 'juwyqofela@mailinator.com', NULL, '2020-09-14 19:19:28', '2020-10-09 12:58:34', 7, 'update', '0'),
(20, 104, 'Serena', 'Len Dominguez', 'Albert', '2008-01-14', '2068-01-14', 'R2222T2', 'Female', '1998-07-27', 'Velit ipsa veritat', 'Perferendis in sequi', 'Kingston', '922-538-9941', '682-154-7347', '', 'juwyqofela@mailinator.com', NULL, '2020-09-14 19:19:28', '2020-10-09 12:58:34', 7, 'update', '0'),
(21, 96, 'Thor', 'Ali Delgado', 'Hicks', '1977-09-06', '2037-09-06', '76NK90I', 'Female', '1972-09-26', '', '', '', '', '', '', '', NULL, '2020-09-11 15:19:46', '2020-10-09 13:23:48', 7, 'update', '0'),
(22, 96, 'Thor', 'Ali Delgado', 'Hicks', '1977-09-06', '2037-09-06', '76NK90I', 'Female', '1972-09-26', '', '', '', '', '', '', '', NULL, '2020-09-11 15:19:46', '2020-10-09 13:23:48', 7, 'update', '0'),
(23, 103, 'Roary', 'Gary Poole', 'Mathis', '2020-03-14', '2085-03-14', '', 'Male', '2015-03-07', '', '', '', '', '', '', '', NULL, '2020-09-14 19:04:07', '2020-10-09 14:42:41', 7, 'update', '0'),
(24, 103, 'Roary', 'Gary Poole', 'Mathis', '2020-03-14', '2085-03-14', '', 'Male', '2015-03-07', '', '', '', '', '', '', '', NULL, '2020-09-14 19:04:07', '2020-10-09 14:42:41', 7, 'update', '0'),
(25, 106, 'Ella', 'Kermit Tyler', 'Morse', '2001-02-19', '2066-02-19', 'TY5553', 'Male', '1987-01-05', '', '', '', '', '555-268-9533', '', '', NULL, '2020-09-14 19:22:28', '2020-10-09 14:43:50', 7, 'update', '0'),
(26, 106, 'Ella', 'Kermit Tyler', 'Morse', '2001-02-19', '2066-02-19', 'TY5553', 'Male', '1987-01-05', '', '', '', '', '555-268-9533', '', '', NULL, '2020-09-14 19:22:28', '2020-10-09 14:43:50', 7, 'update', '0'),
(27, 106, 'Ella', 'Kermit Tyler', 'Morse', '2001-02-19', '2066-02-19', 'TY5553', 'Male', '1987-01-05', '', '', '', '', '555-268-9533', '', '', NULL, '2020-09-14 19:22:28', '2020-10-09 14:43:50', 7, 'delete', '0'),
(28, 105, 'Jessie', '', 'Pateler', '2014-04-16', '2079-04-16', 'XR5333', 'Male', '1998-07-27', '', '', '', '', '', '', '', NULL, '2020-09-14 19:19:48', '2020-10-09 14:44:50', 7, 'update', '0'),
(29, 105, 'Jessie', '', 'Pateler', '2014-04-16', '2079-04-16', 'XR5333', 'Male', '1998-07-27', '', '', '', '', '', '', '', NULL, '2020-09-14 19:19:48', '2020-10-09 14:44:50', 7, 'update', '0'),
(30, 108, 'Zelda', '', 'Martinez', '1992-12-08', '2057-12-08', NULL, 'Male', '1995-01-14', '', NULL, NULL, NULL, NULL, '', '', NULL, '2020-09-14 19:24:07', '2020-09-14 19:24:07', 7, 'delete', '0'),
(31, 156, 'Bell', '', 'David', '1988-11-07', '2053-11-07', NULL, 'Male', '1974-04-27', '', NULL, NULL, NULL, NULL, '', '', NULL, '2020-09-16 16:54:29', '2020-09-16 16:54:29', 7, 'delete', '0'),
(36, 120, 'Shay', 'Zelenia Malone', 'Fryes', '2018-12-28', '2083-12-28', 'Y4Y4646', 'Male', '1981-12-06', '', '', '', '', '', '', '', NULL, '2020-09-14 20:04:35', '2020-10-09 15:09:35', 7, 'update', '56262626'),
(37, 120, 'Shay', 'Zelenia Malone', 'Fryes', '2018-12-28', '2083-12-28', 'Y4Y4646', 'Male', '1981-12-06', '', '', '', '', '', '', '', NULL, '2020-09-14 20:04:35', '2020-10-09 15:09:35', 7, 'update', '56262626'),
(38, 121, 'Rina', 'Kylee Stevenson', 'Clayson', '1983-11-10', '2043-11-10', 'HW225264', 'Female', '1990-03-18', '', '', '', '', '', '', '', NULL, '2020-09-14 20:06:00', '2020-10-09 15:12:15', 7, 'update', '522623623'),
(39, 121, 'Rina', 'Kylee Stevenson', 'Clayson', '1983-11-10', '2043-11-10', 'HW225264', 'Female', '1990-03-18', '', '', '', '', '', '', '', NULL, '2020-09-14 20:06:00', '2020-10-09 15:12:15', 7, 'update', '522623623'),
(40, 102, 'Jame', 'Daphne', 'Darcey', '1960-07-01', '2020-07-01', 'RT86915', 'Female', '2014-02-15', '', '', '', '', '', '', '', NULL, '2020-09-12 13:42:44', '2020-10-09 15:16:32', 7, 'update', '569368523'),
(41, 102, 'Jame', '', 'Darcey', '1960-07-01', '2020-07-01', 'RT86915', 'Female', '2014-02-15', '', '', '', '', '', '', '', NULL, '2020-09-12 13:42:44', '2020-10-09 15:16:56', 7, 'update', '569368523'),
(42, 102, 'Jame', '', 'Darcey', '1960-07-01', '2020-07-01', 'RT86915', 'Female', '2014-02-15', '', '', '', '', '', '', 'test@mail.com', NULL, '2020-09-12 13:42:44', '2020-10-09 15:17:21', 7, 'update', '569368523'),
(43, 93, 'Ryders', 'Jayme', 'Chapman', '1950-01-31', '2015-01-31', 'BX4532', 'Male', '1982-06-02', '14 Tom Road', 'Mandeville', 'Portland', '876-555-5555', '876-555-6666', 'gyqyhas@mailinator.com', 'test@email.com', NULL, '2020-09-11 15:06:20', '2020-10-09 16:16:14', 7, 'update', '567345879'),
(44, 157, 'Ivana', '', 'Howard', '1976-08-26', '2041-08-26', NULL, 'Male', '1978-01-09', '', NULL, NULL, NULL, NULL, '', '', NULL, '2020-09-16 16:54:41', '2020-09-16 16:54:41', 7, 'delete', NULL),
(45, 158, 'Ivana', '', 'Howard', '1976-08-26', '2041-08-26', NULL, 'Male', '1978-01-09', '', NULL, NULL, NULL, NULL, '', '', NULL, '2020-09-16 16:55:59', '2020-09-16 16:55:59', 7, 'delete', NULL),
(52, 109, 'Phoebe', 'Tamekah Benson', 'Rasmussen', '2018-07-18', '2083-07-18', NULL, 'Male', '2020-10-10', '', NULL, NULL, NULL, NULL, 'ariel@phoe.com', '', NULL, '2020-09-14 19:24:32', '2020-10-10 15:59:37', 7, 'update', NULL);
...
('dep1', 'Marketing', '2020-10-05 22:33:32', 7, NULL),
('dep10', 'Sunset', '2020-10-10 19:34:57', 7, NULL),
('dep2', 'Finance', '2020-10-05 22:33:32', 7, NULL),
('dep3', 'Human Resources', '2020-10-05 22:33:32', 7, NULL),
('dep4', 'Production', '2020-10-05 22:33:32', 7, NULL),
...
--
DROP TRIGGER IF EXISTS `tblDepartment_AFTER_DELETE`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tblDepartment_AFTER_INSERT`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tblDepartment_AFTER_UPDATE`;
DELIMITER $$
...
DROP TABLE IF EXISTS `tbldepartment_employee`;
CREATE TABLE IF NOT EXISTS `tbldepartment_employee` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `empID` int(11) NOT NULL,
  `jobID` int(11) NOT NULL,
  `deptID` char(6) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `job_emp_ibfk_1_idx` (`empID`),
  KEY `job_emp_ibfk_2_idx` (`jobID`),
  KEY `deptID` (`deptID`)
...
(7, 93, 22, 'dep1', '2020-10-11', '2021-02-06', '2020-10-07 15:28:06', '2020-10-08 00:38:04', 7),
(9, 94, 16, 'dep0', '2020-10-09', '2020-11-28', '2020-10-07 15:41:14', NULL, 7),
(29, 93, 17, 'dep8', '2020-10-08', '2020-11-07', '2020-10-08 00:10:07', NULL, 7),
(35, 94, 18, 'dep8', '1981-02-07', '2004-05-01', '2020-10-09 17:28:02', NULL, 7),
(36, 93, 18, 'dep8', '1975-12-14', '1970-03-30', '2020-10-09 18:38:23', NULL, 7),
(37, 93, 18, 'dep8', '1975-12-14', '1970-03-30', '2020-10-09 18:39:27', NULL, 7),
(38, 93, 23, 'dep5', '2001-05-07', '2017-05-22', '2020-10-09 18:41:46', NULL, 7),
(43, 93, 14, 'dep8', '2012-08-09', '1983-02-14', '2020-10-09 18:55:47', NULL, 7),
(46, 159, 25, 'dep2', '1986-09-15', '1995-11-17', '2020-10-09 19:08:04', NULL, 7),
(53, 102, 24, 'dep5', '2020-02-12', '2021-04-29', '2020-10-10 14:43:24', NULL, 7),
(54, 109, 1, 'dep5', '2020-10-10', '2021-01-01', '2020-10-10 14:44:35', NULL, 7),
(55, 109, 20, 'dep6', '2020-11-28', '2021-04-02', '2020-10-10 14:45:00', NULL, 7),
(56, 109, 25, 'dep5', '2020-12-12', '2020-10-10', '2020-10-10 14:47:35', NULL, 7),
...
(65, 160, 24, 'dep3', '2020-10-10', '2020-12-25', '2020-10-10 16:52:00', '2020-10-10 17:03:03', 7),
(66, 160, 25, 'dep2', '2020-11-27', '2021-02-05', '2020-10-10 17:06:49', '2020-10-10 17:10:14', 7);

--
-- Triggers `tbldepartment_employee`
--
DROP TRIGGER IF EXISTS `tbldepartment_employee_AFTER_UPATE`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tbldepartment_employee_BEFORE_DELETE`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tbldepartment_employee_BEFORE_INSERT`;
DELIMITER $$
...
DROP TABLE IF EXISTS `tbldepartment_manager`;
CREATE TABLE IF NOT EXISTS `tbldepartment_manager` (
  `empID` int(11) NOT NULL,
  `deptID` char(6) NOT NULL,
...
(109, 'dep10', NULL, NULL),
(109, 'dep2', '2020-12-05', '2002-05-14'),
(109, 'dep5', '2020-12-12', '2020-10-10');
...
DROP TABLE IF EXISTS `tbldepartment_supervisor`;
CREATE TABLE IF NOT EXISTS `tbldepartment_supervisor` (
  `empID` int(11) NOT NULL,
  `deptID` char(6) NOT NULL,
  `from_date` date DEFAULT NULL,
  `to_date` date DEFAULT NULL,
...
(176, 'dep2', '2020-11-27', '2021-02-05'),
(176, 'dep5', '2020-02-12', '2021-04-29');
...
(96, 'Thor', 'Ali Delgado', 'Hicks', '1977-09-06', '2037-09-06', '', '76NK90I', 'Female', '1972-09-26', '', '', '', '', '', '', '', NULL, '2020-09-11 15:19:46', '2020-10-09 13:23:48', 7),
...
(109, 'Phoebe', 'Tamekah Benson', 'Rasmussen', '2018-07-18', '2083-07-18', NULL, NULL, 'Male', '2020-10-10', '', NULL, NULL, NULL, NULL, 'ariel@phoe.com', '', NULL, '2020-09-14 19:24:32', '2020-10-10 15:59:37', 7),
...
--
DROP TRIGGER IF EXISTS `archives_AFTER_UPDATE`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `archives_BEFORE_DELETE`;
DELIMITER $$
CREATE TRIGGER `archives_BEFORE_DELETE` BEFORE DELETE ON `tblemployees` FOR EACH ROW BEGIN
 INSERT INTO archives_employees (empID, first_name, middle_name, last_name, empDOB, retirementDate, trn, nis, gender, hire_date, address, city, parish, phoneOne, mobile, internalEmail, externalEmail, photo, created_date, modified_at, created_by, action)
    VALUES (OLD.empID, OLD.first_name, OLD.middle_name, OLD.last_name,  OLD.empDOB, OLD.retirementDate, OLD.trn, OLD.nis, OLD.gender, OLD.hire_date, OLD.address, OLD.city, OLD.parish, OLD.phoneOne, OLD.mobile, OLD.internalEmail, OLD.externalEmail, OLD.photo, OLD.created_date, OLD.modified_at, OLD.created_by, "delete");
...
DELIMITER $$
CREATE TRIGGER `log_AFTER_INSERT` AFTER INSERT ON `tblemployees` FOR EACH ROW BEGIN
...
DROP TABLE IF EXISTS `tbljobtitles`;
CREATE TABLE IF NOT EXISTS `tbljobtitles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
DROP TRIGGER IF EXISTS `tbljobtitles_AFTER_INSERT`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `updatelog_after_delete`;
DELIMITER $$
